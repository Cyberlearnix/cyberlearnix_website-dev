    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/users/identity/forms/*/public").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/users/identity/forms/active").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/users/identity/forms/*/submit").permitAll()
                        .requestMatchers("/api/users/identity/**").hasAnyRole("ADMIN", "HR", "MANAGER", "SUPER_ADMIN")
                        .requestMatchers("/api/users/**").hasRole("ADMIN")
