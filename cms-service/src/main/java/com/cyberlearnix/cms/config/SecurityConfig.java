    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/cms/pages", "/api/cms/pages/**", "/api/cms/testimonials", "/api/cms/testimonials/**", "/api/cms/recognitions", "/api/cms/recognitions/**").permitAll()
